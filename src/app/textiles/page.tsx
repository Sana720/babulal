      ...
      <section id="collections" className="relative py-24 bg-white overflow-hidden">
        ...
        <div className="max-w-[1700px] mx-auto px-12 lg:px-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-20">
            {LATEST_COLLECTIONS.map((product, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                {/* Product Meta Above Image */}
                <div className="flex justify-between items-center px-4 mb-6">
                  <div>
                    <h4 className="text-[#0A5181] text-2xl font-black tracking-tighter mb-1 transition-colors">{product.name}</h4>
                    <div className="flex items-center gap-3">
                      <span className="text-[#DA222A] text-[9px] font-black uppercase tracking-[.4em]">{product.price}</span>
                    </div>
                  </div>
                ...
                <div className="relative aspect-[4/5] overflow-hidden bg-gray-100 rounded-3xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)]">
                  ...
                  <div className="absolute inset-0 z-20 flex flex-col justify-end p-10 opacity-0 group-hover:opacity-100 translate-y-8 group-hover:translate-y-0 transition-all duration-500">
                    <div className="bg-white/95 backdrop-blur-xl p-8 rounded-xl shadow-2xl">
                      <p className="text-[#DA222A] text-[9px] font-black uppercase tracking-[.3em] mb-2">{product.price}</p>
                      <h4 className="text-gray-900 text-2xl font-black tracking-tight mb-4">{product.name}</h4>
                      <button className="w-full py-3 bg-[#0A5181] text-white text-[9px] font-black uppercase tracking-widest rounded hover:bg-[#DA222A] transition-colors">
                        Enquire for Bulk
                      </button>
                    </div>
                  </div>
            ...
            <div className="lg:translate-y-12 flex flex-col">
              <div className="flex-1 bg-gray-50 border-2 border-dashed border-gray-100 rounded-2xl flex flex-col items-center justify-center p-12 text-center group hover:bg-[#0A5181]/5 hover:border-[#0A5181]/20 transition-all cursor-pointer min-h-[500px]">
      ...
      <section className="relative py-32 overflow-hidden bg-white">
        ...
        <div className="relative z-10 max-w-[1700px] mx-auto px-12 lg:px-24">
          <div className="text-center mb-28 px-4">
            ...
            <h3 className="text-[#0A5181] text-3xl md:text-5xl font-black tracking-tight mb-8">Production Strength</h3>
            <p className="text-gray-500 text-sm md:text-base font-medium max-w-4xl mx-auto leading-relaxed">
              Our Production Strength Lies In Precision, Innovation, And Efficiency. We Deliver Top-Notch Quality, <br className="hidden lg:block" /> Meeting Demands With Excellence And Exceeding Expectations.
            </p>
          </div>
          ...
          <div className="relative h-auto lg:h-[500px]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-y-20 gap-x-8 lg:gap-4 h-full items-center">
              {[
                { name: "Pre-Production", icon: PenTool, num: "01", y: "lg:-translate-y-24" },
                { name: "Cutting", icon: Scissors, num: "02", y: "lg:translate-y-24" },
                { name: "Sewing", icon: Shirt, num: "03", y: "lg:-translate-y-12" },
                { name: "Checking", icon: ClipboardCheck, num: "04", y: "lg:translate-y-12" },
                { name: "Ironing", icon: Flame, num: "05", y: "lg:-translate-y-24" },
                { name: "Packing", icon: Box, num: "06", y: "lg:translate-y-24" },
                { name: "Delivery", icon: Truck, num: "07", y: "lg:translate-y-0" }
              ].map((step, i) => (
                <motion.div
                  key={i}
                  ...
                  transition={{ delay: i * 0.1 }}
                  className={`relative flex flex-col items-center group ${step.y} ${i === 6 ? 'col-span-2 md:col-span-1' : ''}`}
                >
